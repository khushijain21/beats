...
var (
	defaultESToOTelOptions = esToOTelOptions{
		Index:    "filebeat-agent-9.0.0", //TODO: Default should be filebeat-%{[agent.version]}
		Pipeline: "",
	}
)
...
func ToOTelConfig(beatCfg *config.C) (map[string]any, error) {
	...
	otelYAMLCfg := map[string]any{
		...
		"pipeline":   escfg.Pipeline, // pipeline
		...
		// // ClientConfig
		// "proxy_url":         escfg.ProxyURL,                   // proxy_url
